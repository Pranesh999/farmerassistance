  ...
  render() {
    ...
    return (
        <div style={{
            ...
            <div style={{ backgroundColor: 'rgba(15,15,15,0.5)', filter: 'blur(2)', padding: "50px 80px" }}>
          ...
          <Row>
            <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color: 'white' }}>
              ...
              <p>
                <Link to={`/sellCrop`}><Button variant="bg-transparent" style={{ background: 'linear-gradient(to right, #fc5c7d, #6a82fb)', padding: "10px 80px 10px 80px", color: "white", fontSize: "20px", fontFamily: "Forte" }}>Sell Crop</Button></Link>
              </p>
            </Col>
            <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color: 'white' }}>
