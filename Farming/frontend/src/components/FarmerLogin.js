...
class FarmerLogin extends Component {
  ...
  validate = () => {
    ...
    if (!this.state.farmerPassword) {
      passError = "Password cannot be blank";
    }
    if (!this.state.farmerEmail) {
  ...
  handleSubmit = e => {
    ...
    if (formValid(this.state)) {
      console.log(`
              --SUBMITTING--
              farmer Email:${this.state.farmerEmail}
            ...
            <Form
              ...
              <Form.Group controlId="formBasicEmail">
                ...
                <InputGroup>
                  ...
                  <Form.Control className={this.state.farmerEmail.length > 0 ? "error" : null} required autoComplete="off" type="text" id="Email" name="email" value={this.state.farmerEmail} onChange={this.changeEmailHandler} placeholder="Enter Email" />
                </InputGroup>
              ...
              <Form.Group controlId="formBasicPassword">
                ...
                <InputGroup>
                  ...
                  <input placeholder="Enter Password " type="password" name="password"
                    className="form-control" value={this.state.farmerPassword}
