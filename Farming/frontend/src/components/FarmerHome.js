        ...
        <div style={{
          ...
          <Row>
            <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color: 'white' }}>
              ...
              <p>
                <Link to={`/addComplain/${this.state.farmerEmail}`}><Button variant="bg-transparent" style={{ background: 'linear-gradient(to right, #00b09b, #96c93d)', padding: "10px 84px 10px 84px", color: "white", fontSize: "20px", fontFamily: "Forte" }}>Post Complaint</Button></Link>
              </p>
              <p>
              ...
              <p>
              <Link to="/chat"><Button variant="bg-transparent" style={{ background: 'linear-gradient(to right, #fc5c7d, #6a82fb)', padding: "10px 134px 10px 134px", color: "white", fontSize: "20px", fontFamily:"Forte"}}>Chat</Button></Link>
              </p>
            ...
            <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color: 'white' }}>
              ...
              <Card style={{ backgroundColor: 'rgba(15,15,15,0.2)', color: "white", fontSize: "25px", fontFamily: "Forte" }}>
                ...
                <Card.Text>and can also chat with the Dealer!</Card.Text>
