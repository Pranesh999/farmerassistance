...
/*
 * @DeleteMapping("/deleteDealer/{dealerId}") public String
 * deleteDealer(@PathVariable int dealerId) throws DealerNotFoundException {
 * 
 * LOGGER.info("Dealer deleted"); return "Deleted Dealer: " +
